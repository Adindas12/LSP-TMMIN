...
public class preferences {
    ...
    private static SharedPreferences getSharedReferences(Context contest) {
        return PreferenceManager.getDefaultSharedPreferences(contest);
    }
    ...
    public static String getDataAs(Context contest){
        return getSharedReferences(contest).getString(DATA_AS,"");
    }
